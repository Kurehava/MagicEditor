...
from MCT_Tranform import Image2Image
from MCT_Tranform import image_checker as mtic
...
def entry(NAVI, config):
    # 获得待合并文件路径
    merger_path_list, merger_count, multi_pdf_flag, encrypted_file_pw = path_process(NAVI, config)
...
def path_process(NAVI, config):
    ...
    PM_BANNER = '\033[42;30mMerger Conversion Tool\033[0m\n' \
                '\033[41;93mPowered by KurehaSho  \033[0m\n' \
                f'合并转换统合工具 {VERSION}\n' \
                f'{SELECT_DICT[NAVI]} 模式\n' \
                '========================================\n' \
                '请按顺序拖入需要进行合并的图片或者PDF文件并回车\n' \
                '请每次只拖入一个文件！！\n' \
                '请每次只拖入一个文件！！\n' \
                '请每次只拖入一个文件！！\n' \
                '========================================\n' \
...
def multi_pdf_process(merger_path_list, multi_pdf_flag, encrypted_file_pw, config, NAVI):
    ...
    LAST_BANNER = '\033[42;30mMerger Conversion Tool\033[0m\n' \
                  '\033[41;93mPowered by KurehaSho  \033[0m\n' \
                  f'合并转换统合工具 {VERSION}\n' \
                  f'{SELECT_DICT[NAVI]} 模式\n' \
                  '========================================\n'
    ...
    if multi_pdf_flag == 1:
        content = '\033[42;30mMerger Conversion Tool\033[0m\n' \
                  '\033[41;93mPowered by KurehaSho  \033[0m\n' \
                  f'合并转换统合工具 {VERSION}\n' \
                  f'{SELECT_DICT[NAVI]} 模式\n' \
                  '========================================\n' \
...
def mutil_page_editor(merger_path_list, encrypted_file_pw, NAVI, config):
    ...
    banner = '\033[42;30mMerger Conversion Tool\033[0m\n' \
             '\033[41;93mPowered by KurehaSho  \033[0m\n' \
             f'合并转换统合工具 {VERSION}\n' \
             f'{SELECT_DICT[NAVI]} 模式\n' \
             f'SUB: 多页数编辑模式\n' \
