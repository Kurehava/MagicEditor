...
def entry(NAVI, config):
    ...
    system(CLEAR)
    banner = (
        '\033[42;30mMerger Conversion Tool Powered by KurehaSho\033[0m\n'
        f'合并转换统合工具 {VERSION}\n'
...
def ext(NAVI, config):
    ...
    # 转换格式输入判定
    content = '\033[42;30mMerger Conversion Tool Powered by KurehaSho\033[0m\n' \
              f'合并转换统合工具 {VERSION}\n' \
              f'{SELECT_DICT[NAVI]} 模式\n' \
              '========================================\n' \
              '支持的输出文件类型:'
...
def file_input_process(NAVI, config):
    ...
    if select == 1:
        content_2 = '\033[42;30mMerger Conversion Tool Powered by KurehaSho\033[0m\n' \
                    f'合并转换统合工具 {VERSION}\n' \
                    f'{SELECT_DICT[NAVI]} 模式\n' \
                    '==========================='
        if OS_TYPE == "Windows":
